...
public class OPCustomerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("请添加项目的客户类别（只有一个客户请直接点下一步）：");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(customerName.trim().isEmpty() || customerPro.trim().isEmpty()){
            ...
            customerString.append(customerName).append(Constant.TAB__STRING).append(customerPro).append(Constant.NEW_LINE_STRING);
            jTextArea1.setText("");
            jTextArea1.setText(customerString.toString());
        }
